...
const HERO_SPRITES = {
  ...
  lixiaobao: {
    ...
    // ★ 所有施法动画已统一为 cast_universal.png 精灵表，由 battle-animation/battle-renderer 直接绘制
    frameRate: { walk: 150, idle: 300, attack: 80, cast_universal: 90 }
  },
  cat: {
    walk: [
...
const MONSTER_SPRITES = {
  ...
  goblin: {
    ...
    skill: [
      ...
      'SHADOW_MOUSE_SKILL_07','SHADOW_MOUSE_SKILL_08'
    ],
    walk: ['SHADOW_MOUSE_WALK_01', 'SHADOW_MOUSE_WALK_02', 'SHADOW_MOUSE_WALK_03', 'SHADOW_MOUSE_WALK_04', 'SHADOW_MOUSE_WALK_05', 'SHADOW_MOUSE_WALK_06', 'SHADOW_MOUSE_WALK_07', 'SHADOW_MOUSE_WALK_08'],
