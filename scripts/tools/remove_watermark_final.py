...
def remove_watermark_crop(input_path, output_path, crop_width=150, crop_height=60):
    """
    直接裁剪右下角区域，用透明填充
    """
    ...
    for y in range(height - crop_height, height):
        for x in range(width - crop_width, width):
