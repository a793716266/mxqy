...
export const TOWN_MAP_OBJECTS = [
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 123, y: 262, width: 170, height: 200, w: 170, h: 200, assetKey: 'TOWN_FOREST', collisionPadding: 10 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 624, y: 311, width: 150, height: 170, w: 150, h: 170, assetKey: 'TOWN_FOREST', collisionPadding: 10 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 344, y: 229, width: 160, height: 140, w: 160, h: 140, assetKey: 'TOWN_FOREST', collisionPadding: 10 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 1250, y: 150, width: 170, height: 130, w: 170, h: 130, assetKey: 'TOWN_FOREST', collisionPadding: 10 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 926, y: 300, width: 350, height: 240, w: 350, h: 240, assetKey: 'TOWN_SHOP', collisionPadding: 46, npcId: 'shop_keeper' },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 278, y: 250, width: 55, height: 80, w: 55, h: 80, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 230, y: -4, width: 55, height: 75, w: 55, h: 75, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 299, y: -19, width: 55, height: 80, w: 55, h: 80, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 367, y: -10, width: 55, height: 78, w: 55, h: 78, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 423, y: -9, width: 55, height: 78, w: 55, h: 78, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 1222, y: 82, width: 55, height: 75, w: 55, h: 75, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 1157, y: 85, width: 55, height: 72, w: 55, h: 72, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 879, y: 308, width: 55, height: 75, w: 55, h: 75, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 716, y: 482, width: 55, height: 75, w: 55, h: 75, assetKey: 'TOWN_TREE', collisionPadding: 12 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 1284, y: 334, width: 40, height: 35, w: 40, h: 35, assetKey: 'TOWN_ROCK', collisionPadding: 5 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 615, y: 260, width: 40, height: 35, w: 40, h: 35, assetKey: 'TOWN_ROCK', collisionPadding: 5 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 1279, y: 281, width: 42, height: 36, w: 42, h: 36, assetKey: 'TOWN_ROCK', collisionPadding: 5 },
  ...
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 551, y: 312, width: 50, height: 45, w: 50, h: 45, assetKey: 'TOWN_GRASS_PILE', collisionPadding: 8, layer: 'fg' },
  ...
  { type: MAP_OBJ_TYPE.DECORATION, x: 710, y: 850, width: 35, height: 32, w: 35, h: 32, assetKey: 'TOWN_GRASS2', layer: 'fg' },
  ...
  { type: MAP_OBJ_TYPE.DECORATION, x: 742, y: 307, width: 28, height: 28, w: 28, h: 28, assetKey: 'TOWN_FLOWER1', rotation: 90, layer: 'fg' },
  { type: MAP_OBJ_TYPE.DECORATION, x: 889, y: 299, width: 26, height: 26, w: 26, h: 26, assetKey: 'TOWN_FLOWER2', layer: 'fg' },
  ...
  { type: MAP_OBJ_TYPE.BUILDING, x: 356, y: 60, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  ...
  { type: MAP_OBJ_TYPE.DECORATION, x: 835, y: 606, width: 71, height: 60, w: 71, h: 60, assetKey: 'TOWN_BUILDINGS_017_67X56', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.DECORATION, x: 755, y: 625, width: 45, height: 44, w: 45, h: 44, assetKey: 'TOWN_TREES_014_41X40', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 605, y: 511, width: 128, height: 128, w: 128, h: 128, assetKey: 'TOWN_TREE', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 881, y: 565, width: 128, height: 128, w: 128, h: 128, assetKey: 'TOWN_TREE', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: -2, y: 81, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 72, y: 86, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 152, y: 89, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 231, y: 91, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 309, y: 93, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 385, y: 94, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 163, y: 145, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: -3, y: 145, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 418, y: 93, width: 84, height: 87, w: 84, h: 87, assetKey: 'TOWN_BUILDINGS_005_80X83', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 352, y: 148, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 427, y: 70, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 498, y: 76, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 638, y: 82, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 567, y: 80, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.OBSTACLE, x: 781, y: 94, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 709, y: 87, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 850, y: 100, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 921, y: 94, width: 79, height: 78, w: 79, h: 78, assetKey: 'TOWN_BUILDINGS_009_75X74', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 818, y: 169, width: 90, height: 42, w: 90, h: 42, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 900, y: 167, width: 90, height: 42, w: 90, h: 42, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 494, y: 94, width: 90, height: 89, w: 90, h: 89, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 740, y: 123, width: 90, height: 89, w: 90, h: 89, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 655, y: 124, width: 90, height: 89, w: 90, h: 89, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 575, y: 124, width: 90, height: 89, w: 90, h: 89, assetKey: 'TOWN_BUILDINGS_002_86X85', collisionPadding: 5, rotation: 180 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 934, y: 126, width: 89, height: 73, w: 89, h: 73, assetKey: 'TOWN_BUILDINGS_008_85X69', collisionPadding: 5, rotation: 90 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 482, y: 153, width: 103, height: 47, w: 103, h: 47, assetKey: 'TOWN_BUILDINGS_021_99X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 862, y: 183, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 567, y: 175, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 705, y: 175, width: 135, height: 47, w: 135, h: 47, assetKey: 'TOWN_BUILDINGS_014_131X43', collisionPadding: 5 },
  { type: MAP_OBJ_TYPE.BUILDING, x: 1001, y: 79, width: 91, height: 107, w: 91, h: 107, assetKey: 'TOWN_MAPS_005_87X103', collisionPadding: 5 },
]
